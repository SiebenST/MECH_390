...
#output values
output_columns = ["Return Ratio", "Peak Power", "System Volume", "System Area", "Min Link Width", "Min Pin Diameter", "Min Crank Width"]
...
pickle.dump(scalers, open('scalers.pkl', 'wb')) #saves input/output scaler for reuse
...
#--------------------------
#Below section of data visualization generated by Gemini 3.1 Pro (or maybe 3.0 Flash thinking, I forget which)
#--------------------------
